...
BOARD_OS_BOARD:=SPARK_STM32_F103

# Where to find the HAL layer
BOARD_OS_HAL:=STM32F1xx

# Where to find the ChibiOS port for the MCU
BOARD_OS_PORT:=GCC/ARMCMx/STM32F1xx
...
UPLOAD_COMMAND=../../../tools/linux64/dfu/dfu-util -d 1d50:607f -a 0 -s 0x08005000:leave -D build/viper.bin
