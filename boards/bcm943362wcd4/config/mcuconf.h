...
main clock = HSI/M*N/P = 120MHz
Usb = HSI/M*N/Q = 48MHz
I2Sclk = HSI/M*N2/R <= 192MHz
HSI=16MHz
M=16
N=240
P=2
...
----------------
ignore the above: it is valid for boards using HSI. 
bcm943363wcd4 has an external oscillator of 26Mhz at hse...
